...
\DeclareMathOperator{\starname}{star}
\DeclareMathOperator{\bipname}{bip}
\DeclareMathOperator{\forname}{for}

% Parameters indexed by a family of colored pairs
\newcommand{\starparam}[1]{\starname_{#1}}
\newcommand{\bipparam}[1]{\bipname_{#1}}
\newcommand{\forparam}[1]{\forname_{#1}}
...
\german{aca intente resolver el abuso de notacion}
\german{una idea que tengo es una vez q definimos bip12 el patron, definir el paraemtro bip12(G) como el minimo 
numero de clases... sin definir nunca el molesto minclases}
\[
...
\german{tmb esta el tema que bip12(G) o bip12 ahi hay un abuso de notacion no?}
