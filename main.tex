...
\german{estos dos estan duplicados, cual te gusta mas sensei?}
...
\german{si uso de lo Cp chromatic, tengo q cambiar esto}
...
P' C P para decir esto de arriba?}
...
\german{o sea del teorema que habla de dada particion, se deduce el de param generales}
...
v_2v_3\in E(G).
\]
Therefore \edgecondition{} does not hold for any of the three bipartite colored patterns.\eric{reescribir esto de alguna forma.}
